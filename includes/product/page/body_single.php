            ...
            <div id="content-wrapper" class="d-flex flex-column">
                                ...
                                <div class="card shadow mb-4">
                                    <div class="card-header py-3">
                                        ...
                                        <h6 class="m-0 font-weight-bold text-primary text-right">
                                            ...
                                            <button type="button" class="btn btn-dark btn-sm" value="<?php echo $id; ?>" name="pay" id="pay_button" data-toggle="modal" data-target="#pay_modal">Pay</button>
                                            ...
                                            <button type="button" class="btn btn-primary btn-sm" data-toggle="modal" data-target="#invoiceModal">Invoice</button>
                                    ...
                                    <div class="card-body">
                                        <?php echo get_single_project($id); ?>
                                    </div>
                                </div>
                                <!-- album -->
                ...
                <div class="modal fade" id="remove_modal" tabindex="-1" role="dialog" aria-labelledby="remove_modalLabel" aria-hidden="true">
                    <div class="modal-dialog modal-lg" role="document">
                        <div class="modal-content">
                            <div class="modal-header">
                                <h5 class="modal-title" id="remove_modalLabel">Remove Product</h5>
                                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                    <span aria-hidden="true">&times;</span>
                                </button>
                            </div>
