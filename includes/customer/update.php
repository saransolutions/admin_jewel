...
//                 <div class="col-md-6 mb-3"><label for="advance">Paid amount *</label><input type="text" class="form-control" id="advance" name="advance" placeholder="" value="'.$result["advance_amount"].'" readonly>
