...
function get_single_page($id, $module, $page_title, $page_php)
{
?>
    <!DOCTYPE html>
    <html lang="en">
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-6">
                                ...
                                <div class="card shadow mb-4">
                                        ...
                                        <h6 class="m-0 font-weight-bold text-primary">
                                            <nav aria-label="breadcrumb">
                                                <ol class="breadcrumb">
                                                    ...
                                                    <li class="breadcrumb-item"><a href="products.php"></a><?php echo $page_title; ?></li>
                                    ...
                                    <div class="card-body">
                                        <?php echo get_single($id, $module, $page_title, $page_php); ?>
                                    </div>
                                </div>
                                <!-- album -->
